...
function EditTransactionPage() {
  ...
  useEffect(() => {
    if (existingTransaction && products) {

  console.log(existingTransaction.date.split('T')[0]);

      setForm({
        product_id: existingTransaction.product_id.toString(),
        quantity: existingTransaction.quantity,
        type: existingTransaction.type,
        date: existingTransaction.date.split('T')[0], // Format date for input type="date"
  ...
  }, [existingTransaction, products, transactionError, navigate]);
